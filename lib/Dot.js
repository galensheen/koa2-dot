...
export default class Dot {
    ...
    async _getTemplate(filepath) {
        ...
        if (this.cacheable && this._getTemplateCache(filepath)) {
            return this._getTemplateCache(filepath);
        }
        ...
        if (this.cacheable) {
            this._setTemplateCache(filepath, {configs, template});
        }
